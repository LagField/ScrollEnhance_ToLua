...
UnityEngine_UI_ScrollRect = UnityEngine.UI.ScrollRect
---@type UnityEngine.EventSystems.UIBehaviour
UnityEngine_EventSystems_UIBehaviour = UnityEngine.EventSystems.UIBehaviour
---@type UnityEngine.RectTransform
UnityEngine_RectTransform = UnityEngine.RectTransform
...
---@type fun(f : fun(arg1 : number) : number)
...
---@type fun(f : fun(driven : UnityEngine.RectTransform))
UnityEngine_RectTransform_ReapplyDrivenProperties = UnityEngine.RectTransform.ReapplyDrivenProperties
